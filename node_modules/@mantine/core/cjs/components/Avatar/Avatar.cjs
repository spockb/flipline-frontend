...
const Avatar = polymorphicFactory.polymorphicFactory((_props, ref) => {
  const props = useProps.useProps("Avatar", null, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Box.Box,
    {
      ...
      ref,
      ...others,
      children: error || !src ? /* @__PURE__ */ jsxRuntime.jsx("span", { ...getStyles("placeholder"), title: alt, children: children || typeof name === "string" && getInitials.getInitials(name) || /* @__PURE__ */ jsxRuntime.jsx(AvatarPlaceholderIcon.AvatarPlaceholderIcon, {}) }) : /* @__PURE__ */ jsxRuntime.jsx(
        "img",
        {
          ...imageProps,
          ...getStyles("image"),
